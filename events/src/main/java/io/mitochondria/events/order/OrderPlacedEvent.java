...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3848450988391290871L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"io.mitochondria.events.order\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"productName\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static io.mitochondria.events.order.OrderPlacedEvent.Builder newBuilder() {
    return new io.mitochondria.events.order.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static io.mitochondria.events.order.OrderPlacedEvent.Builder newBuilder(io.mitochondria.events.order.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new io.mitochondria.events.order.OrderPlacedEvent.Builder();
    } else {
      return new io.mitochondria.events.order.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static io.mitochondria.events.order.OrderPlacedEvent.Builder newBuilder(io.mitochondria.events.order.OrderPlacedEvent other) {
    if (other == null) {
      return new io.mitochondria.events.order.OrderPlacedEvent.Builder();
    } else {
      return new io.mitochondria.events.order.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.mitochondria.events.order.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.mitochondria.events.order.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder setProductName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder clearProductName() {
      productName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.order.OrderPlacedEvent.Builder clearQuantity() {
