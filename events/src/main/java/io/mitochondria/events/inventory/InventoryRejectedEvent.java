...
public class InventoryRejectedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -16919659175131996L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"InventoryRejectedEvent\",\"namespace\":\"io.mitochondria.events.inventory\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public static io.mitochondria.events.inventory.InventoryRejectedEvent.Builder newBuilder() {
    return new io.mitochondria.events.inventory.InventoryRejectedEvent.Builder();
  }
   ...
   * @return A new InventoryRejectedEvent RecordBuilder
   */
  public static io.mitochondria.events.inventory.InventoryRejectedEvent.Builder newBuilder(io.mitochondria.events.inventory.InventoryRejectedEvent.Builder other) {
    if (other == null) {
      return new io.mitochondria.events.inventory.InventoryRejectedEvent.Builder();
    } else {
      return new io.mitochondria.events.inventory.InventoryRejectedEvent.Builder(other);
    }
  }
   ...
   * @return A new InventoryRejectedEvent RecordBuilder
   */
  public static io.mitochondria.events.inventory.InventoryRejectedEvent.Builder newBuilder(io.mitochondria.events.inventory.InventoryRejectedEvent other) {
    if (other == null) {
      return new io.mitochondria.events.inventory.InventoryRejectedEvent.Builder();
    } else {
      return new io.mitochondria.events.inventory.InventoryRejectedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InventoryRejectedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.mitochondria.events.inventory.InventoryRejectedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.mitochondria.events.inventory.InventoryRejectedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.inventory.InventoryRejectedEvent.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.inventory.InventoryRejectedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.inventory.InventoryRejectedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.events.inventory.InventoryRejectedEvent.Builder clearEmail() {
      email = null;
